...
class ServerDashboard extends ConsumerStatefulWidget {
  final SpiRequiredArgs args;
  const ServerDashboard({super.key, required this.args});

  @override
  ConsumerState<ServerDashboard> createState() => _ServerDashboardState();
}

class _ServerDashboardState extends ConsumerState<ServerDashboard> with SingleTickerProviderStateMixin {
  ...
  Widget _buildMainPage(ServerState si) {
    ...
    final children = <Widget>[if (logo != null) logo];
